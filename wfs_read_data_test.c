/*===============================================================================================================================
	...
	Changelog:     Aug-23-18 -> 1.0 -> First version created
				   ...
				   Apr-12-19 -> 1.4 -> Added wavefront tilt cancel at loading
...
void main ()
{
	...
	float			  SAMPLE_PUPIL_CENTROID_Y, SAMPLE_PUPIL_CENTROID_X, SAMPLE_PUPIL_DIAMETER_X, SAMPLE_PUPIL_DIAMETER_Y, SAMPLE_OPTION_CANCEL_TILT;
	...
	printf("\nCancel tilt correction (1) or not (0)\n");
	fflush(stdin);
	scanf("%d", &SAMPLE_OPTION_CANCEL_TILT);
